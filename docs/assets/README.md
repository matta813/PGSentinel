...
`pgsentinel-wait-events.png` is generated by the main product screenshot workflow from deterministic documentation-only wait samples. Production APIs never use these fixtures.
