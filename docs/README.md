...
- [Architecture](architecture.md): components, data flow, storage, and extension points
- [Development](development.md): local toolchain, checks, and dependency updates
