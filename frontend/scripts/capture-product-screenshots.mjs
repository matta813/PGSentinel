...
try {
      ...
      "wait-events": [
        {
          ...
          StateAgeSeconds: 47,
          TransactionStartedAt: "2026-08-31T08:29:08.000Z",
        },
        {
          PID: 19104,
          Database: "payments",
          ...
          QueryAgeSeconds: 18,
          TransactionAgeSeconds: 18,
          StateAgeSeconds: 18,
          TransactionStartedAt: "2026-08-31T08:29:42.000Z",
        },
        {
          PID: 20117,
          Database: "customer_reporting_archive_2026",
          User: "reporting",
          Application: "report-worker",
          ClientAddress: "10.21.9.20",
          BackendType: "client backend",
          State: "active",
          WaitEventType: "LWLock",
          WaitEvent: "BufferMapping",
          Query:
            "SELECT date_trunc($1, created_at), count(*) FROM order_events GROUP BY 1",
          QueryAgeSeconds: 31,
          TransactionAgeSeconds: 31,
          StateAgeSeconds: 31,
          TransactionStartedAt: "2026-08-31T08:29:29.000Z",
        },
        {
          PID: 20480,
          Database: "payments",
  ...
  for (const [route, filename] of [
    ...
    ["wait-events", "pgsentinel-wait-events.png"],
