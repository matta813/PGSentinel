...
try {
  ...
  await page.route('**/api/v1/**', async route => {
    ...
    const body = pathname.endsWith('/freshness') ? freshness : pathname.includes(`/servers/${server.id}/`) ? resourceBodies[resource] : bodies[pathname]
  ...
  for (const [route, filename] of [['queries', 'pgsentinel-query-performance.png'], ['indexes', 'pgsentinel-index-analysis.png'], ['replication', 'pgsentinel-replication.png'], ['settings', 'pgsentinel-settings.png']]) {
