...
export function ProblemsPage() {
  ...
  if (monitoring.selectedServerId)
    query.set("serverId", monitoring.selectedServerId);
  if (monitoring.selectedDatabase)
    query.set("database", monitoring.selectedDatabase);
  ...
  useEffect(() => {
    ...
    if (monitoring.selectedDatabase)
      next.set("database", monitoring.selectedDatabase);
