...
export function ProblemsPage() {
  ...
  return <>
    <div className="title-row"><div><p className="eyebrow">Problems inbox</p><h1>What needs attention</h1><p>Findings persist, update and resolve as conditions change.</p></div></div>
    <div className="filters">
      ...
      <select aria-label="Status" value={status} onChange={e => setStatus(e.target.value)}><option value="active">Active</option><option value="resolved">Resolved</option><option value="all">All</option></select>
